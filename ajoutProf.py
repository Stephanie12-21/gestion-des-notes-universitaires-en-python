...
################################################################################
## Form generated from reading UI file 'ajoutProf.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.frame.setMinimumSize(QSize(550, 593))
        self.frame.setMaximumSize(QSize(550, 593))
...
"")
        ...
        self.gradeComboBox = QComboBox(self.frame_4)
        ...
        self.gradeComboBox.setMinimumSize(QSize(151, 41))
        self.gradeComboBox.setMaximumSize(QSize(151, 41))
        font1 = QFont()
        font1.setPointSize(11)
        self.gradeComboBox.setFont(font1)
        self.gradeComboBox.setStyleSheet(u"color: rgb(83, 177, 220);\n"
"border:1px solid #63C8DC;")

        self.horizontalLayout_6.addWidget(self.gradeComboBox)
        ...
        self.nomLineEdit = QLineEdit(self.frame_2)
        ...
        self.nomLineEdit.setFont(font1)
...
"border:1px solid #63C8DC;")
        ...
        self.numTelLineEdit = QLineEdit(self.frame_2)
        ...
        self.numTelLineEdit.setFont(font1)
...
"border:1px solid #63C8DC;")
        ...
        self.adresseLineEdit = QLineEdit(self.frame_2)
        ...
        self.adresseLineEdit.setFont(font1)
...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QCoreApplication.translate("Dialog", u"Nouvel enseignant", None))
        self.gradeComboBox.setItemText(0, QCoreApplication.translate("Dialog", u"Choisir le grade", None))
        self.gradeComboBox.setItemText(1, QCoreApplication.translate("Dialog", u"Enseignant vacataire", None))
        self.gradeComboBox.setItemText(2, QCoreApplication.translate("Dialog", u"Enseignant chercheur", None))
        self.gradeComboBox.setItemText(3, QCoreApplication.translate("Dialog", u"Docteur", None))
        self.gradeComboBox.setItemText(4, QCoreApplication.translate("Dialog", u"Professeur", None))
        self.gradeComboBox.setItemText(5, QCoreApplication.translate("Dialog", u"HDR", None))
