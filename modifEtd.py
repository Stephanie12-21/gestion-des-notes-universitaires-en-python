...
################################################################################
## Form generated from reading UI file 'modifEtd.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(606, 643)
        Dialog.setMinimumSize(QSize(606, 643))
        Dialog.setMaximumSize(QSize(606, 643))
...
"")
        ...
        self.verticalSpacer_5 = QSpacerItem(20, 31, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
...
"border-radius:10px;")
        ...
        self.dateNaissance.setStyleSheet(u"color: #63C8DC;\n"
"background-color:#EBE9FC;\n"
"border-radius:10px;")
        ...
        self.verticalSpacer_4 = QSpacerItem(20, 31, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
        ...
        self.nomLineEdit.setMinimumSize(QSize(550, 41))
...
"border-radius:10px;")
        ...
        self.numTelLineEdit.setMinimumSize(QSize(461, 41))
...
"border-radius:10px;")
        ...
        self.verticalLayout_5.setContentsMargins(-1, -1, 11, -1)
...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.mentionComboBox.setItemText(2, QCoreApplication.translate("Dialog", u"Syst\u00e8mes et r\u00e9seaux", None))
